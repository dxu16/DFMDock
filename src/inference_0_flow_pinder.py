...
from datasets.pinder_subset_dataset import PinderDataset
...
class Sampler:
    def __init__(
        ...
        # get testset
        testset = PinderDataset(
            test_split=self.data_conf.dataset, 
            mode='test', 
            use_esm=True,
        )
    ...
    def run_sampling(self):
        ...
        for batch in tqdm(self.test_dataloader):
            ...
            incomplete_struct = False in batch['rec_pos_mask'] or False in batch['lig_pos_mask']
            ...
            if self.data_conf.get_gt_energy:
                ...
                for i in tqdm(range(self.data_conf.num_samples)):
                    ...
                    if incomplete_struct:
                        if i == 0:
                            print(f"Missing backbone atoms in input, skip saving pdbs for {_id}")
                    else:
